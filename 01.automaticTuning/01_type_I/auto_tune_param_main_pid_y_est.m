...
function [Gc Gp stepinformation ti_MO x_MO y_MO stepinformation_Gp] = auto_tune_param_main_pid_y_est(plant_loc)
...
td = plant_loc.td  ;    kp = plant_loc.kp  ;    kh = plant_loc.kh  ;
                        x2_optimal = plant_loc.x2_optimal;
...
% % &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
% y_MO = (b2 - b1)/(a22 - a12);
% x_MO = (b1*a22 - a12*b2)/(a22 - a12);
% ti_MO = 2*kp*(w1 - q1 - x_MO) ;
% &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
% making the assumption y_MO = x_MO(x_MO - x2_optimal);
x_MO = (a22/(a22 - a12)) * x2_optimal - (a12*b2)/(a22 - a12);
% y_MO = (b2 - x_MO) / a22                                ;
y_MO = x_MO*(x_MO - x2_optimal);
ti_MO = 2*kp*(w1 - q1 - x_MO) ;
