...
function [Fcl_MO Fcl_optimal Gp stepinformation ti_MO x_MO y_MO optimalControllerData Gc_1] = autotune_param_typeII_calculateOvs(plant_loc)
...
optimalControllerData(1) = ti_optimal;
optimalControllerData(2) = tn_optimal;
...
tsz = 1.941025;
ti_MO = sqrt((1/2)*kp*kh*(tn_MO^2 + tsz));
...
% Optimal controller 2
% -------------------------------------------------------------------------
tn = 2*(w1-q1) + sqrt(4*(w1-q1)^2 - (q1^2 + 2*(2*w2 + q2 - 2*w1*q1)));   
tn_meth2_sol = tn;
x_optimal_1  = tn_meth2_sol                 ;
y_optimal_1  = 0                          ;  
ti_optimal_1 = sqrt((1/2)*kp*kh*(x_optimal_1^2 + q1^2 - 2*q2));
ti_optimal_square_1 = ti_optimal_1^2        ;

num0Gc_opt_1 = 1                       ;
num1Gc_opt_1 = x_optimal_1                    ;
num2Gc_opt_1 = y_optimal_1                    ;
numGc_optimal_1 = [num2Gc_opt_1 num1Gc_opt_1 num0Gc_opt_1];
    
den0Gc_opt_1 = 0                       ;
den1Gc_opt_1 = 0                       ;
den2Gc_opt_1 = ti_optimal_square_1            ;
den3Gc_opt_1 = ti_optimal_square_1*tp6        ;

denGc_optimal_1 = [den3Gc_opt_1 den2Gc_opt_1 den1Gc_opt_1 den0Gc_opt_1];
Gc_optimal_1 = tf(numGc_optimal_1,denGc_optimal_1)    ; 
Gc_1 = Gc_optimal_1  ;
