...
function [Fcl_MO Fcl_optimal Gp stepinformation ti_MO x_MO y_MO optimalControllerData] = autotune_param_typeII_calculateOvs(plant_loc)
...
ti_MO = sqrt((1/2)*kp*kh*(tn_MO^2 + 1.941025));
